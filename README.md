    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            PageButton.MouseButton1Click:Connect(function()
                ...
                for i,v in next, ScrollPage:GetChildren() do 
                    ...
                    TweenService:Create(
                        PageButton,
                        TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
                        {TextColor3 = Color3.fromRGB(96, 255, 16)}
                    ):Play()
                end
            end)
            ...
            function main:AddToggle(text,config,callback)
                ...
                ToggleImage2.BackgroundColor3 = Color3.fromRGB(96, 255, 16)
            ...
            function main:AddSlider(text,min,max,set,callback)
                ...
                Bar.Name = "Bar"
                Bar.Parent = Bar1
                Bar.BackgroundColor3 = Color3.fromRGB(96, 255, 16)
            ...
            function main:AddSeperator(text)
                ...
                Sep1.BackgroundColor3 = Color3.fromRGB(96, 255, 16)
                ...
                Sep2.BackgroundColor3 = Color3.fromRGB(96, 255, 16)
            ...
            function main:AddLine()
                ...
                Linee.Name = "Linee"
                Linee.Parent = Line
                Linee.BackgroundColor3 = Color3.fromRGB(96, 255, 16)
