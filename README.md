do
	local ui = game.CoreGui:FindFirstChild("UILIBMOBILE")
	if ui then
		ui:Destroy()
	end
	if _G.Color == nil then
		_G.Color = Color3.fromRGB(26,255,0)
	end
end
...
function library:AddWindow(text,logo,keybind)
	...
	local UILIBMOBILE = Instance.new("ScreenGui")
	UILIBMOBILE.Name = "UILIBMOBILE"
	UILIBMOBILE.Parent = game.CoreGui
	UILIBMOBILE.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = UILIBMOBILE
...
local win = library:AddWindow("1XLII","",Enum.KeyCode.RightControl)
AutoFarm = win:AddTab("Auto Farm")
Stats = win:AddTab("Stats")
 Auto = win:AddTab("Auto")
 tp = win:AddTab("Teleport")
 Raid = win:AddTab("Raid")
 Shop = win:AddTab("Shop")
 Misc = win:AddTab("Misc")
 Setting = win:AddTab("Setting")
 Cr = win:AddTab("Credit")
...
AutoFarm:Toggle("Auto Farm Chest",false,function(v)
	AutoFarmChest = v
end)
...
Setting:Toggle("Delete Attack Fx",false,function(d)
    _G.DeleteAttackFx = d
end)
